...
2. A latent_dim értékét akkor tekinthetjük optimálisnak a teljesség megvalósíthatósága szempontjából, ha latent_dim = $N_{típus}-1$, vagyis latent_dim egyel kisebb a típusok számánál. Ekkor a különféle típusok egyikét véve azok egyedei egy sokdimenziós tetraéder egyik adott csúcsa körül csoportosulnak. Ilyenkor bármely két, vagy több típus közti átmenet, vagy azok keveréke is magától értetődő módon tud reprezentálódni.
