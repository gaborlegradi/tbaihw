...
- A train adatokkal a latent_dim reprezentációba beszórt **z_mean értékek**re (mintavételezés **ki**kapcsolva, Test0x.ipynb notebookok ábráin a középső és alsó plotok) is ráfittelnék egy Gauss-eloszlást, de ekkor már a szigmát csak annyira kötném meg, hogy legyen diagonális mátrix. Mindegyik (tehát mindkét) latent_dim-beli dimenzióban az alapján mondanék konfidenciát arra vonatkozóan, hogy egy adott input reprezentációja az adott dimenzióban vett Gauss-eloszlás várható értékétől hány szigma távolságra esik. Értelmes konfidencia értéket képezhetünk a Gauss-eloszlás sűrűségfüggvényéből: $conf = \dfrac{\varphi_{\mu, \sigma}(z_{mean})}{\varphi_{\mu, \sigma}(\mu)}$.
